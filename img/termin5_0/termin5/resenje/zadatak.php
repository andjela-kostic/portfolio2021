        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="offset-sm-3 col-sm-6">
                <h4 class="text-center">Studentska služba - UPIS</h4><br/>
                <div class="card">
                    <div class="card-header card-header-success">
                        <h4 class="card-title">Studenti</h4>
                        <a href="forma.php" class="btn btn-warning">Unesi studenta</a>
                    </div>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody id="kategorije">
                          ...
                          <tr>
                            ...
                            <td><?= $student[2] ?></td>
                            <td>
                              <a href="forma.php?id=<?= $br-1?>">Izmeni</a>
                            </td>
                            <td>
                              <a href="models/studenti/delete.php?id=<?= $br-1 ?>">Obrisi</a>
                            </td>
                          </tr>  
